...
public class ManagerPanel extends JPanel implements ActionListener{
	...
	public ManagerPanel(String user){
		...
		bottomManagerPanel = new JPanel();
		bottomManagerPanel.setLayout(new GridLayout(2, 3,5, 5));
		bottomManagerPanel = ActionMethod.inventory();	
		bottomManagerPanel.setVisible(false);
		...
		managerPanel.add(Box.createRigidArea(new Dimension(0, 20)));
		managerPanel.add(bottomManagerPanel);
		add(managerPanel);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == inventory){
			...
			bottomManagerPanel.setVisible(true);
		}
